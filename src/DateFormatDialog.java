...
import uk.org.blankaspect.gui.TaggedText;
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private HelpDialog( )
        {
            ...
            if ( helpDialogLocation == null )
                helpDialogLocation = GuiUtilities.getComponentLocation( this, DateFormatDialog.this );
...
////////////////////////////////////////////////////////////////////////
    ...
    public static DateFormat showDialog( Component    parent,
                                         ...
                                         List<String> names )
    {
        return new DateFormatDialog( GuiUtilities.getWindow( parent ), titleStr, dateFormat, names ).
                                                                                        getDateFormat( );
    }
...
////////////////////////////////////////////////////////////////////////
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( nameField );
            throw e;
        }
        ...
        {
            GuiUtilities.setFocus( patternField );
            throw e;
        }
