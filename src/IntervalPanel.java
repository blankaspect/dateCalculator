...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private static TextAreaDialog showDialog( Component parent,
                                                  ...
                                                  String    text )
        {
            return new TextAreaDialog( GuiUtilities.getWindow( parent ), titleStr, text );
        }
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        Window window = GuiUtilities.getWindow( this );
        ...
        switch ( mode )
        {
            case NUM_INTERVALS:
                ...
                GuiUtilities.setAllEnabled( endDatePanel, false );
                break;
            ...
            case END_DATE:
                ...
                GuiUtilities.setAllEnabled( endDatePanel, true );
                numIntervalsSpinner.setEnabled( false );
                numDaysSpinner.setEnabled( false );
                break;
        }
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( startDatePanel.getDateField( ).getField( e.getKey( ) ) );
        ...
        switch ( mode )
        {
            ...
            case END_DATE:
            {
                ...
                {
                    GuiUtilities.setFocus( endDatePanel.getDateField( ).getField( e.getKey( ) ) );
