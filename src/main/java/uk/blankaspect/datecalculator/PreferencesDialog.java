...
////////////////////////////////////////////////////////////////////////
	...
	private static final	String	SHOW_ADJACENT_MONTHS_STR	= "Show days of adjacent months";
...
////////////////////////////////////////////////////////////////////////
	...
	{
		if (monthNames == null)
			monthNames = AppConfig.INSTANCE.getMonthNames();
	...
	{
		if (dayNames == null)
			dayNames = AppConfig.INSTANCE.getDayNames();
		List<String> names = DateNameDialog.showDialog(this, EDIT_DAY_NAMES_STR, dayNames,
													   DateUtils.getDayNames(Locale.getDefault()));
		if (names != null)
			dayNames = names;
	}
	...
	private JPanel createPanelAppearance()
	{
		...
		JLabel showAdjacentMonthsLabel = new FLabel(SHOW_ADJACENT_MONTHS_STR);
		...
		gbc.fill = GridBagConstraints.NONE;
		gbc.insets = AppConstants.COMPONENT_INSETS;
		gridBag.setConstraints(showAdjacentMonthsLabel, gbc);
		controlPanel.add(showAdjacentMonthsLabel);

		// Combo box: show adjacent months
		showAdjacentMonthsComboBox = new BooleanComboBox(config.isShowAdjacentMonths());
		...
		gbc.fill = GridBagConstraints.NONE;
		gbc.insets = AppConstants.COMPONENT_INSETS;
		gridBag.setConstraints(showAdjacentMonthsComboBox, gbc);
		controlPanel.add(showAdjacentMonthsComboBox);
	...
	private JPanel createPanelDate()
	{
		...
		for (String str : DateUtils.getDayNames(Locale.getDefault()))
	...
	private void setPreferencesAppearance()
	{
		...
		config.setShowAdjacentMonths(showAdjacentMonthsComboBox.getSelectedValue());
	}
