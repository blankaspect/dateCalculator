...
////////////////////////////////////////////////////////////////////////
	...
	private static final	String	PROPERTIES_FILENAME	= DateCalculatorApp.NAME_KEY + "-properties"
															+ AppConstants.XML_FILENAME_EXTENSION;
	private static final	String	FILENAME_STEM		= DateCalculatorApp.NAME_KEY + "-config";
	...
	private interface Key
	{
		...
		String	CONFIGURATION				= DateCalculatorApp.NAME_KEY + "Configuration";
		String	DATE						= "date";
...
////////////////////////////////////////////////////////////////////////
	...
	{
		DateCalculatorApp.INSTANCE
				.showWarningMessage(DateCalculatorApp.SHORT_NAME + " : " + CONFIGURATION_ERROR_STR, exception);
	}
	...
	{
		DateCalculatorApp.INSTANCE
				.showErrorMessage(DateCalculatorApp.SHORT_NAME + " : " + CONFIGURATION_ERROR_STR, exception);
	}
