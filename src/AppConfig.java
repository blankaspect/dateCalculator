...
//--////////////////////////////////////////////////////////////////////
    ...
    public String addDateFormatObserver( Property.Observer observer )
    {
        cpDateFormats.observers.add( observer );
        return cpDateFormats.getKey( );
    }

    //------------------------------------------------------------------

    public void notifyDateFormatObservers( )
    {
        cpDateFormats.notifyObservers( );
    }
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            super( concatenateKeys( Key.DATE, Key.MONTH_NAME ), DateUtilities.NUM_MONTH_NAMES );
            fill( new String( ) );
        }
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private CPDayNames( )
        {
            super( concatenateKeys( Key.DATE, Key.DAY_NAME ), DateUtilities.NUM_DAY_NAMES );
            fill( new String( ) );
        }
    ...
    public void updateDateNames( )
    {
        switch ( getDateNamesSource( ) )
        {
            case LOCALE:
            {
                ...
                DateUtilities.setMonthNames( DateUtilities.getMonthNames( locale ) );
                DateUtilities.setDayNames( DateUtilities.getDayNames( locale ) );
                break;
            }

            case USER_DEFINED:
                DateUtilities.setMonthNames( getMonthNames( ) );
                DateUtilities.setDayNames( getDayNames( ) );
                break;
        }
    }
