...
Gradle build script : DateCalculator
...
val packageName     = "datecalculator"
val mainClassName   = "uk.blankaspect.${packageName}.DateCalculatorApp"

val buildDir    = layout.buildDirectory.get().getAsFile().toString()
val jarDir      = _path(buildDir, "bin")
val jarFilename = "dateCalculator.jar"
